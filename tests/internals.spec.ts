...
describe('Internals', () => {
  ...
  //   test.skip('Internal error is thrown when suppressErrors = false', async () => {
  //     const jwti = new Jwti(jwt, {} as RedisClientType, {
  ...
  //   test.skip('Internal error is not logged when allowLogging = false', async () => {
  //     const jwti = new Jwti(jwt, {} as RedisClientType, {
  ...
  //   test.skip('Internal error is logged to errorLogger', async () => {
  ...
  //   test.skip('Internal error is logged to console.error', async () => {
  //     const jwti = new Jwti(jwt, {} as RedisClientType);
  //     await jwti.verify(await jwti.sign('PAYLOAD', 'SECRET'), 'SECRET');
  //     expect(mockConsoleError.mock.calls.length).toBe(1);
  //   });
